...
class featureExtraction():
    def __init__(self, dataframe):
        ...
        # log value of following and followers are also our features!!
    ...
    def _following(self):
        """ categorically dividing number of following into 5 categories """
        category = []
    ...
    def _follower(self):
        """ categorically dividing number of followers into 5 categories  """
        category = []
    ...
    def _post(self):
        """ categorically dividing number of posts into 5 categories  """
        category = []
    ...
    def _privacy(self):
        ''' 
        Numeric labelling from text labelling into 3 categories
        2: Open Account
        1: Close Account
        0: unknown account
        '''
    ...
    def _ratioFollowingFollower(self):
        ''' number of followers per followings is also our metric'''
